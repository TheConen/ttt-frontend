...
export const CSP_CONFIG: CSPConfig = {
    ...
    fontSrc: ["'self'", TRUSTED_SOURCES.google.fontsStatic, TRUSTED_SOURCES.discord.main],

    imgSrc: ["'self'", 'data:', 'blob:', TRUSTED_SOURCES.discord.main, TRUSTED_SOURCES.discord.cdn, TRUSTED_SOURCES.discord.assets],

    connectSrc: ["'self'", 'ws:', 'wss:', TRUSTED_SOURCES.discord.main, TRUSTED_SOURCES.discord.gateway],

    frameSrc: ["'self'", TRUSTED_SOURCES.discord.main],

    childSrc: ["'self'", TRUSTED_SOURCES.discord.main],
...
export const PRODUCTION_CSP_CONFIG: Partial<CSPConfig> = {
    ...
    styleSrc: ["'self'", TRUSTED_SOURCES.google.fonts, TRUSTED_SOURCES.discord.main],
};
