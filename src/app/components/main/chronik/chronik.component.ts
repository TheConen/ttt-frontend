  ...
  readonly timelineEvents: TimelineEvent[] = [
    ...
    },
    {
      ...
      details: [
        ...
        'Partnerschaft mit ArmaWorld etabliert'
      ]
    },
    {
      id: 'tvt-era',
      ...
      icon: 'pi-trophy',
      details: [
        'Start der Electronic Sports Masters™ (ESM)',
