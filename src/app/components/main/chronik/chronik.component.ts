...
export class ChronikComponent implements OnInit {
  ...
  private createTimelineEvents(): TimelineEvent[] {
    const eventData: (Omit<TimelineEvent, 'id'> & { id: string })[] = [
      ...
      { id: 'server-handover', date: 'Juni 2016', title: 'Operation Handover', description: 'Beendigung des TTT-Public-Servers und Übertragung an ArmaWorld', type: 'system', icon: 'pi-server', details: ['Strategische Neuausrichtung der Community', 'Fokus auf Events statt Public Gaming'] },
      { id: 'tvt-era', date: 'September 2018', title: 'Operation Gladiator', description: 'Neue Sparte im TTT: TVT-Team und E-Sport-Ära', type: 'milestone', icon: 'pi-trophy', details: ['Electronic Sports Masters™ (ESM)', 'Wettkampforientierte Missionsformate', 'Professionelle E-Sport-Aktivitäten'] },
      ...
      { id: 'rank-structure', date: 'März 2019', title: 'Operation Hierarchy', description: 'TTT-Rangneustrukturierung zu Soldat, Veteran und Gast', type: 'system', icon: 'pi-sitemap', details: ['Vereinfachte Rangstruktur eingeführt', 'Etablierung von Offiziersposten'] },
      { id: 'website-relaunch', date: 'September 2020', title: 'Operation Digital', description: 'Neuer TTT-Webauftritt mit modernem Design', type: 'milestone', icon: 'pi-globe', details: ['Responsive Design für alle Geräte', 'Verbesserte Navigation', 'Integration moderner Webtechnologien'] },
